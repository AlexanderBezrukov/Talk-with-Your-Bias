...
class Visualisation:
    def __init__(self, model_name: str):
        ...
        self.CONDENSE_PROMPT = "You are high qualified Data Analyst."
        self.todo_prompt = """
        Visualize all bias detection metrics and statistical disparities from the report and select the best type of plot (indicator, bar, scatter or pie) from plotly.graph_objects to make reasonable visualisation of the metrics to show fairness across protected attributes. Add colors to improve user experience.
